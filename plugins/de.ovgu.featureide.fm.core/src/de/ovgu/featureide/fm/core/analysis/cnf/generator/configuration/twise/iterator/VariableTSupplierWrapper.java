 ...
 * @author karls
 */
public class VariableTSupplierWrapper {

	private final List<PresenceCondition> presenceConditions;
	private final ICombinationSupplier<int[]> supplier;
	private final int t;

	public VariableTSupplierWrapper(List<PresenceCondition> presenceConditions, ICombinationSupplier<int[]> supplier, int t) {
		this.presenceConditions = presenceConditions;
		this.supplier = supplier;
		this.t = t;
	}

	public List<PresenceCondition> getPresenceConditions() {
		return presenceConditions;
	}

	public ICombinationSupplier<int[]> getSupplier() {
		return supplier;
	}
